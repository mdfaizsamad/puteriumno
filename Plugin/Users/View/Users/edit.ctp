        ...
        <div class="row">
          ...
          <!-- </div> -->
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-md-4 control-label" for="UserUserRoleId">User User Role</label>
                    <div class="col-md-8">
                      <?php 		echo $this->Form->input('User.user_role_id',array('label'=>'','between'=>'<div class="col-md-12">','options' => $roles));?>                    </div>
                </div>
                <!-- // Group END -->
          </div>
          ...
          <div class="col-md-6">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <?php echo $this->Form->input('User.study_centre_id',array('label'=>'','between'=>'<div class="col-md-12">', 'options' => $study_centres));?>                    </div>
              </div>
              <!-- // Group END -->
          </div>
            <!-- <div class="col-md-6"> -->
