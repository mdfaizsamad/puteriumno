                ...
                <?php
                  ...
                  foreach($data['StuTransaction'] as $transaction) : ?>
                    ...
                    ?>
                        ...
                        <?php endif; ?>
                    <?php elseif($transaction['entry_type'] == 'debit' && $transaction['TransactionType']['id'] == 4) : //debug($data['StuTransaction']);die;?>
                        <?php if(@$transaction['FeeType']['is_soa_reflected'] == false) : 
                        $empty = 0;
                    ?>
                        <tr>
                  ...
                  <td colspan=4 align="right"><b>Sub Total</b></td>
                    <td>
                        ...
                        foreach($data['StuTransaction'] as $transaction){
                          ...
                          if($transaction['entry_type'] == 'debit'  && $transaction['TransactionType']['id'] == 4 && @$transaction['FeeType']['is_soa_reflected'] == false){
                            $balanceDebit=$balanceDebit + $transaction['amount']; 
                          }//end if debit
                        }//END FOREACH
                  ...
                  <td colspan=4 align="right"><b>Grand Total</b></td>
                    <td>
                        ...
                        foreach($data['StuTransaction'] as $transaction){
                          ...
                          if($transaction['entry_type'] == 'debit'  && $transaction['TransactionType']['id'] == 4){
                            $balanceDebit=$balanceDebit + $transaction['amount']; 
                          }//end if debit
                        }//END FOREACH
                        echo '<b>'.CakeNumber::currency($balanceDebit, '', ['zero'=>'','negative'=>'-']).'</b>';
