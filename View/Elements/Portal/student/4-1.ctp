<div class="box  box-warning">
            ...
            <div class="box-header with-border">
              ...
              <a align='center' href="<?php echo Routed::url(array('plugin'=>'accommodation','controller'=>'tenancy_masters','action'=>'view_details_student'))?>" class="badge bg-blue pull-right"><i class="fa fa-eye"></i>&nbsp;View</a>
            </div>
