    ...
    <div class="box">
      <div class="box-header">
        <div class="box-title col-md-11">
          <?php echo $this->Form->create('Province',array("type"=>"get","id"=>"IndexForm"))?>          <div class="input-group">
        ...
        <table class="table table-hover table-bordered">
          ...
          <tbody>
            <?php foreach ($provinces as $province): ?>
              <tr>
                      				<td><?php echo $province["Province"]["code"]; ?>&nbsp;</td>
                                     				<td><?php echo $province["Province"]["province"]; ?>&nbsp;</td>
                                     				<td><?php echo $province["Province"]["status"]; ?>&nbsp;</td>
                                     <td style='min-width:186px;'>
                                    <a href="<?php echo Routed::url(array('action'=>'edit',$province['Province']['id']))?>" class="btn btn-success btn-xs colorBoxIframe"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
            <a href="<?php echo Routed::url(array('action'=>'delete',$province['Province']['id']))?>"  class="btn btn-danger btn-xs colorBoxIframe"><i class="fa fa-eraser"></i> Delete</a>
          </td>
        </tr>
