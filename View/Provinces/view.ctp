			...
			<div class="col-md-9">
				<div class="box box-primary">
             		<div class="box-header with-border">
						...
						<div class="box-tools"><?=h($province['Province']['code']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">province</h3>
						<div class="box-tools"><?=h($province['Province']['province']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">status</h3>
						<div class="box-tools"><?=h($province['Province']['status']);?></div>
					</div><!-- /.box-header -->
