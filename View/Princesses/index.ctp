          ...
          <tbody>
            <?php foreach ($princesses as $princess): ?>
              <tr>
                      ...
                      <?php echo $this->Html->link($princess['Parliament']['id'], array('controller' => 'parliaments', 'action' => 'view', $princess['Parliament']['id'])); ?>
                  </td>
                      ...
                      <?php echo $this->Html->link($princess['Branch']['id'], array('controller' => 'branches', 'action' => 'view', $princess['Branch']['id'])); ?>
                                            ...
                                            <td class='center text-inverse'>
                      <?php echo $this->Html->link($princess['Age']['id'], array('controller' => 'ages', 'action' => 'view', $princess['Age']['id'])); ?>
                  </td>
