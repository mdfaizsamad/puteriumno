			...
			<div class="col-md-9">
				<div class="box box-primary">
             		<div class="box-header with-border">
						...
						<div class="box-tools"><?=h($parliament['Parliament']['code']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">parliament</h3>
						<div class="box-tools"><?=h($parliament['Parliament']['parliament']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">status</h3>
						<div class="box-tools"><?=h($parliament['Parliament']['status']);?></div>
					</div><!-- /.box-header -->
