			...
			<div class="col-md-9">
				<div class="box box-primary">
             		<div class="box-header with-border">
						...
						<div class="box-tools"><?=h($locality['Locality']['code']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">locality</h3>
						<div class="box-tools"><?=h($locality['Locality']['locality']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">status</h3>
						<div class="box-tools"><?=h($locality['Locality']['status']);?></div>
					</div><!-- /.box-header -->
