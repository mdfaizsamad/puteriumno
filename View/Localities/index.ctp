    ...
    <div class="box">
      <div class="box-header">
        <div class="box-title col-md-11">
          <?php echo $this->Form->create('Locality',array("type"=>"get","id"=>"IndexForm"))?>          <div class="input-group">
        ...
        <table class="table table-hover table-bordered">
          ...
          <tbody>
            <?php foreach ($localities as $locality): ?>
              <tr>
                      				<td><?php echo $locality["Locality"]["code"]; ?>&nbsp;</td>
                                     				<td><?php echo $locality["Locality"]["locality"]; ?>&nbsp;</td>
                                     				<td><?php echo $locality["Locality"]["status"]; ?>&nbsp;</td>
                                     <td style='min-width:186px;'>
                                    <a href="<?php echo Routed::url(array('action'=>'edit',$locality['Locality']['id']))?>" class="btn btn-success btn-xs colorBoxIframe"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
            <a href="<?php echo Routed::url(array('action'=>'delete',$locality['Locality']['id']))?>"  class="btn btn-danger btn-xs colorBoxIframe"><i class="fa fa-eraser"></i> Delete</a>
          </td>
        </tr>
