<div class="widget">
    ...
    <div class="widget-body innerAll">
        <!-- Row -->
        <div class="row">
          <?php 		echo $this->Form->input('Age.id');?>
            <div class="col-md-6">
                <!-- Group -->
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <?php 		echo $this->Form->input('Age.category',array('label'=>'','between'=>'<div class="col-md-12">'));?>                    </div>
                </div>
                <!-- // Group END -->
          </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <label class="col-md-4 control-label" for="AgeStatus">Age Status</label>
                    <div class="col-md-8">
                      <?php 		echo $this->Form->input('Age.status',array('label'=>'','between'=>'<div class="col-md-12">'));?>                    </div>
                </div>
                <!-- // Group END -->
          </div>
