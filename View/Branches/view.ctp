			...
			<div class="col-md-9">
				<div class="box box-primary">
             		<div class="box-header with-border">
						...
						<div class="box-tools"><?=h($branch['Branch']['dun_vote_id']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">code</h3>
						<div class="box-tools"><?=h($branch['Branch']['code']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">branch</h3>
						<div class="box-tools"><?=h($branch['Branch']['branch']);?></div>
					</div><!-- /.box-header -->

                         		<div class="box-header with-border">
						<h3 class="box-title">status</h3>
						<div class="box-tools"><?=h($branch['Branch']['status']);?></div>
					</div><!-- /.box-header -->
