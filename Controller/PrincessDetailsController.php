 ...
 */
class PrincessDetailsController extends AppController {
 ...
 */
	public function add() {
		...
		$creators = $this->PrincessDetail->Creator->find('list');
		$modifiers = $this->PrincessDetail->Modifier->find('list');
		$this->set(compact('princesses', 'genders', 'races', 'creators', 'modifiers'));
	}
