 ...
 */
class PrincessesController extends AppController {
 ...
 */
	public function add() {
		...
		$creators = $this->Princess->Creator->find('list');
		$modifiers = $this->Princess->Modifier->find('list');
		$this->set(compact('parliaments', 'duns', 'dunVotes', 'branches', 'ages', 'creators', 'modifiers'));
	}
